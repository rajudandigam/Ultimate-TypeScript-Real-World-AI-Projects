...
### Recommended Stack
Tailored for **AML Investigation Multi-Agent System** (Multi-Agent, L5): prioritize components that match **multi** orchestration and the **fintech** integration surface.
