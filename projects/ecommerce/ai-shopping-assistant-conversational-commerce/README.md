...
### Recommended Stack
Tailored for **AI Shopping Assistant (Conversational Commerce)** (Agent, L4): prioritize components that match **agent** orchestration and the **ecommerce** integration surface.
