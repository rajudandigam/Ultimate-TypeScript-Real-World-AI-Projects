...
### Recommended Stack
Tailored for **AI Evaluation Framework (LLM Testing System)** (Workflow, L5): prioritize components that match **workflow** orchestration and the **ai-infra** integration surface.
